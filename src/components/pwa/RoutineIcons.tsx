...
export const RoutineIcons = {
    pierna: (color: string) => (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M7 4L6 10C6 10 5 14 5 17C5 20 7 22 7 22" stroke={color} strokeWidth="2.5" strokeLinecap="round" />
            <path d="M17 4L18 10C18 10 19 14 19 17C19 20 17 22 17 22" stroke={color} strokeWidth="2.5" strokeLinecap="round" />
    ...
    pecho: (color: string) => (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="2" y="2" width="20" height="20" rx="6" fill="white" fillOpacity="0.03" />
            <path d="M12 20C12 20 4 18 4 11C4 7 7 5 12 5M12 20C12 20 20 18 20 11C20 7 17 5 12 5" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    ...
    espalda: (color: string) => (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="2" y="2" width="20" height="20" rx="6" fill="white" fillOpacity="0.03" />
            <path d="M5 7L12 5L19 7L20 13C20 17 17 20 12 21C7 20 4 17 4 13L5 7Z" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    ...
    brazo: (color: string) => (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="2" y="2" width="20" height="20" rx="6" fill="white" fillOpacity="0.03" />
            <path d="M4 13C4 13 7 9 11 9C15 9 18 12 18 12L21 10" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
...
export const RoutineIconRenderer = React.memo<{ type: string; color?: string; className?: string }>(({ type, color, className }) => {
    const iconFn = (RoutineIcons as any)[type];
    if (!iconFn) return null;
    return <div className={className}>{iconFn(color || '#FFFFFF')}</div>;
});

RoutineIconRenderer.displayName = 'RoutineIconRenderer';
