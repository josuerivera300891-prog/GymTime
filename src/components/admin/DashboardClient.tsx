    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="glass-card p-6">
                    <h3 className="text-lg font-bold text-white mb-4">📢 Membresías Vencidas (Sin Renovar)</h3>
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-red-500/20 rounded-full flex items-center justify-center text-red-500 font-bold text-xl">
                            {stats.expiredCount}
                        </div>
                        <div>
                            <div className="text-white text-sm">Clientes vencieron hoy</div>
                            <Link href="/admin/members?filter=expired" className="text-brand-400 text-xs hover:underline">Ver lista completa →</Link>
                        </div>
                    </div>
                </div>
            </div>
